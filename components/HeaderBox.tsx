...
const HeaderBox = ({ type, user }: HeaderBoxProps) => {
  return (
    <section className='header-box'>
      <div className='kIxwnO'>
        <div className='hzJipK'>
          <button title='Canada' className='jhHFnw'>CA</button>
        ...
        <div className='glzYUk'>
          <a href="https://www.paypal.com/ca/webapps/mpp/paypal-popup">
            <img
              src="//uk.tmconst.com/production-10-119-0-9353350/images/ads/paypal_small.svg"
      ...
      <div className='header-up sticky-header cMVZvC'>
        ...
        <div className='header-left eyILZd'>
          <button className='cuvXCU'>
            <svg viewBox="0 0 23 24" width="1.5em" height="1.5em" aria-hidden="true" focusable="false" className="BaseSvg-sc-yh8lnd-0 MagnifyingGlassIcon___StyledBaseSvg-sc-1pooy9n-0 ckLyyv"><path d="M3.78 4.78 1.62 10l2.16 5.22L9 17.38l5.22-2.16L16.38 10l-2.16-5.22L9 2.62zM9 1l6.36 2.64L18 10l-2.33 5.61 6.11 6.11-1.06 1.06-6.1-6.1L9 19l-6.36-2.64L0 10l2.64-6.36z"></path></svg>
          </button>

          {type === 'home' ? (<></>) : (
            <div className='jsVeLW'>
              <form action="" className='drfekD'>
                <div className='hAEHHw'>
                  <input type="text" placeholder='Search' className='search-bar hyuHCP' />
                  <button className='jZzXmc'>
                    <svg viewBox="0 0 23 24" width="1.35em" height="1.35em" aria-hidden="true" focusable="false" className="BaseSvg-sc-yh8lnd-0 MagnifyingGlassIcon___StyledBaseSvg-sc-1pooy9n-0 ckLyyv"><path d="M3.78 4.78 1.62 10l2.16 5.22L9 17.38l5.22-2.16L16.38 10l-2.16-5.22L9 2.62zM9 1l6.36 2.64L18 10l-2.33 5.61 6.11 6.11-1.06 1.06-6.1-6.1L9 19l-6.36-2.64L0 10l2.64-6.36z"></path></svg>
                  </button>
                </div>
              </form>
            </div>
          ...
          <button className='jIuguz'>
            <svg viewBox="0 0 24 24" width="24px" height="24px" aria-hidden="true" focusable="false" className="BaseSvg-sc-yh8lnd-0 UserIcon___StyledBaseSvg-sc-16rhua7-0 ckLyyv"><path d="M8 6.5a4 4 0 1 1 8 0 4 4 0 0 1-8 0M12 1a5.5 5.5 0 1 0 0 11 5.5 5.5 0 0 0 0-11m6.49 12H5.43L1 16.9V23h22v-6.12zM2.5 17.58 6 14.5h11.93l3.57 3.07v3.93h-19z"></path></svg>
            <span>Sign In/Register</span>
          </button>
        </div>
      </div>
      <div className='header-down sticky-header cMVZvC'>
       <SearchBar />
      </div>
    </section>
  )
